...
SECRET_KEY = '9njkh_ix@cnt+6v1q3zmj#o!((nn*=bk(zoaeg&_%ox#++#f$l'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'userApp.context_processors.session',
                'userApp.context_processors.authform',
                'cartApp.context_processors.cart_count',
            ],
        },
    },
]
...
AUTHENTICATION_BACKENDS = [
    ...
    'userApp.backends.main_auth.EmailAuthBackend',
]
